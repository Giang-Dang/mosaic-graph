...
/// <summary>
/// Mosaic's order history, seeded in memory. Eight orders spread over seven of
/// the twelve customers, so that one customer has two orders and most have
/// none. Chapter 4 replaces this file with a database.
/// </summary>
public sealed class InMemoryOrderingData
{
    ...
    [
        ...
        [
            new(ProductId(1), 1, new Money(1249.00m, Currency)),
            new(ProductId(2), 6, new Money(229.00m, Currency)),
            new(ProductId(7), 1, new Money(189.00m, Currency))
        ]),

        new(OrderId(2), CustomerId(1), new DateTimeOffset(2026, 2, 3, 17, 40, 0, TimeSpan.Zero),
        [
            new(ProductId(18), 2, new Money(119.00m, Currency))
        ]),

        new(OrderId(3), CustomerId(3), new DateTimeOffset(2026, 2, 18, 11, 5, 0, TimeSpan.Zero),
        [
            new(ProductId(12), 1, new Money(159.00m, Currency)),
            new(ProductId(13), 1, new Money(79.00m, Currency)),
            new(ProductId(16), 1, new Money(69.00m, Currency)),
            // Bought during a January clearance, below today's list price.
            new(ProductId(17), 1, new Money(49.00m, Currency))
        ]),

        new(OrderId(4), CustomerId(4), new DateTimeOffset(2026, 3, 2, 8, 30, 0, TimeSpan.Zero),
        [
            new(ProductId(3), 1, new Money(1690.00m, Currency)),
            new(ProductId(4), 1, new Money(349.00m, Currency))
        ]),

        new(OrderId(5), CustomerId(7), new DateTimeOffset(2026, 3, 21, 14, 55, 0, TimeSpan.Zero),
        [
            new(ProductId(20), 2, new Money(189.00m, Currency)),
            new(ProductId(21), 4, new Money(29.50m, Currency))
        ]),

        new(OrderId(6), CustomerId(9), new DateTimeOffset(2026, 4, 7, 19, 20, 0, TimeSpan.Zero),
        [
            new(ProductId(23), 2, new Money(429.00m, Currency))
        ]),

        new(OrderId(7), CustomerId(11), new DateTimeOffset(2026, 4, 26, 10, 10, 0, TimeSpan.Zero),
        [
            // The desk was on offer that week.
            new(ProductId(5), 1, new Money(549.00m, Currency)),
            new(ProductId(9), 1, new Money(89.50m, Currency)),
            new(ProductId(25), 3, new Money(34.00m, Currency))
        ]),

        new(OrderId(8), CustomerId(12), new DateTimeOffset(2026, 5, 15, 16, 0, 0, TimeSpan.Zero),
        [
            new(ProductId(6), 1, new Money(899.00m, Currency)),
            new(ProductId(10), 2, new Money(129.00m, Currency)),
            new(ProductId(11), 3, new Money(24.00m, Currency)),
            new(ProductId(22), 1, new Money(149.00m, Currency))
        ])
    ];
}
