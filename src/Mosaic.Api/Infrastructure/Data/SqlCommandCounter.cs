...
/// <remarks>
/// <para>
/// This is the number the chapter is about, and it is deliberately measured at
/// the lowest point available rather than inferred higher up. A resolver that
/// calls a service that calls a DataLoader that shares a context is several
/// layers away from a round trip; an interceptor on the command is not.
/// </para>
/// <para>
