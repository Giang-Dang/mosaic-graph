...
public static class ReviewsDataRegistration
{
    /// <summary>
    ...
    {
        services.AddPooledDbContextFactory<ReviewsDbContext>((serviceProvider, options) =>
            options
        ...
        services.AddScoped(serviceProvider =>
            serviceProvider.GetRequiredService<IDbContextFactory<ReviewsDbContext>>()
                .CreateDbContext());

        services.AddHostedService<ReviewsDatabaseSeeder>();
